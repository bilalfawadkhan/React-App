...
return(
    ...
    className="success"
    style ={{
        display : sumbitted ? '' : 'none', color: "green"
    }}>
            ...
            <div className="screen__content">
                ...
                {successMessege()} 
                    ...
                    <div className="login__field">
                        <i className="login__icon fas fa0-user"></i>
                        <input type="text" onChange={handleEmail} className="login__input" placeholder="User name / Email" autoComplete="False"/>
                        {/* <section className="login__error">Please enter a valid email address</section> */}
                    </div>
                    <div className="login__field">
                        <i className="login__icon fas fa-lock"></i>
                        <input type="password" onChange={handlePassword} className="login__input" placeholder="Password" autoComplete="false"/>
                    </div>
                    <div className={`password_validation ${password?'show' : ''}`}>
                    ...
                    <div className={`login__field ${password ? 'move' : ''}`}>
                        <i className="login__icon fas fa-lock"></i>
                        <input type="password" onChange={handleRePassword} className="login__input" placeholder="Repeat Password" autoComplete="false"/>
                    </div>
